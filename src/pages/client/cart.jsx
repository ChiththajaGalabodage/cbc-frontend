...
export default function CartPage() {
  ...
  return (
    <div className="w-full max-w-full h-full flex flex-col items-center pt-4  relative ">
      <div className="z-50 hidden w-[400px] h-[80px] shadow-2xl absolute bottom-1 md:top-1 right-1 flex flex-col justify-center items-center">
      ...
      <div className="z-50 md:hidden  w-full h-[100px] shadow-2xl flex flex-col justify-center items-center">
        <p className="text-2xl text-secondary font-bold">
          Total:
          <span className="text-accent font-bold mx-2">
            {getTotal().toFixed(2)}
